...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className='hidden md:flex absolute md:top-[20%] lg:top-[14%] right-2 max-w-[64%] w-full z-10'>
      ...
      <div className='absolute  right-4 w-[12.5rem] h-[20rem]  lg:block bottom-[5rem] lg:w-[10rem] lg:h-[20rem] overflow-hidden rounded-lg shadow-lg z-4 '>
