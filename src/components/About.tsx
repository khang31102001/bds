  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto flex flex-col items-center justify-center gap-4">
        {/* Title */}
        <h1 className="text-h1 font-bold text-cyan-900 text-center">
          About Boyup Brook
        </h1>

        <p className="text-normal text-gray-700 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-wrap md:flex-row items-center justify-center gap-4 md:gap-8">
          {landInfo.map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="text-h2 font-bold text-cyan-900 mb-1">{count.toLocaleString()}</div>
